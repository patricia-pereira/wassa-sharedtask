...
class Tokenizer(TextEncoder):
    ...
    def encode(self, sequence: str) -> torch.Tensor:
        ...
        if self.context:
            return self.tokenizer(sequence, truncation=True, add_special_tokens=False)["input_ids"]

        else:
            return self.tokenizer(sequence, truncation=True, add_special_tokens=True)["input_ids"]
